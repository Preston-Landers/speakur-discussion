...
module.exports = function (grunt) {
  ...
  // configurable paths
  var yeomanConfig = {
    app: 'components/speakur-discussion',
    dist: 'components/speakur-discussion-dist'
  };
...
*/
        ...
        files: {
          '<%= yeoman.dist %>/elements.vulcanized.html': [
            '<%= yeoman.dist %>/speakur-discussion.html'
          ]
        }
      }
    },
    ...
    minifyHtml: {
      ...
      app: {
        files: [{
          expand: true,
          cwd: '<%= yeoman.dist %>',
          src: ['*.html','!elements.vulcanized.html'],
          dest: '<%= yeoman.dist %>'
        }
/* ,
        {
...
*/
  ...
  grunt.registerTask('build', [
    ...
    // demo only uses imported elements
    // 'concat',
